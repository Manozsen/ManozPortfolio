...
const DEFAULT_POPUP: PopupSettings = {
  ...
  description:
    "See exactly what your website will look like before spending a rupee.",
  image: "",
...
const DEFAULT_SEO: SeoSettings = {
  ...
  description:
    "I build high-converting websites for creators, local businesses, and Instagram-based sellers. Get a free demo today.",
  keywords:
    "web developer, portfolio, website design, Instagram seller website, local business website, Next.js developer India",
  ogImage: "",
};
