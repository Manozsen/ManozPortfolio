...
export default function HeroSection({ headline, subtext }: Props) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-violet-50 py-16 md:py-24">
